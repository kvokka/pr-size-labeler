...
Mikhail Beliakov ("Me", "Myself", and "I") built Pull Request Labeler (the "app") as an Open Source GitHub App. This service is provided by myself and is intended for use as is.
...
The app is hosted on [huggingface](https://huggingface.co/). No user data is persisted besides a temporary storage of log files for less than 30 days.
...
If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at `kvokka@yahoo.com`.
